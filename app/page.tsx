    ...
    <>
      ...
      <BlurHalo open={liveOpen} onOpenChange={setLiveOpen}>
        <BlurHaloContent spread={60} strength={0.5} labelledBy="blurhalo-demo-title">
          <h2
            id="blurhalo-demo-title"
            className="text-lg font-semibold leading-none tracking-tight"
          >
            Try BlurHalo
          </h2>
          <p className="text-sm text-muted-foreground">
            This dialog uses the BlurHalo component. The halo fades out around the edge — the rest
            of the page stays sharp.
          </p>
          <p className="text-sm text-muted-foreground">
            The dialog body has{" "}
        ...
        >
          <div>
            ...
            <p className="mt-5 max-w-[560px] text-[17px] leading-relaxed tracking-tight text-black/60 dark:text-white/55">
              ...
              , BlurHalo only blurs the area immediately around the dialog. The rest of the page
              stays crisp and readable while the focused surface gets a soft, feathered backdrop
              blur that fades naturally outward.
            </p>
          ...
          <section id="api" className="mt-24">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              {[
                ...
                >
                  <strong className="mb-2 block text-[15px] -tracking-[0.02em]">
                    {card.title}
                  </strong>
